...
public class DBQuery {
    public static String CreateQuery(String type, Object o) {
        String sql = null;
        if (type == "add_movie") {
            sql = "INSERT INTO MOVIES(NAME, COORDINATES_ID, CREATION_DATE, OSCARS_COUNT, GOLDEN_PALM_COUNT, USA_BOX_OFFICE, MPAA_RATING, PERSON_ID, USERNAME) VALUES(" + ((Movie)o).toSQL() + ")";
            ...
            sql = "INSERT INTO MOVIES(ID, NAME, COORDINATES_ID, CREATION_DATE, OSCARS_COUNT, GOLDEN_PALM_COUNT, USA_BOX_OFFICE, MPAA_RATING, PERSON_ID, USERNAME) VALUES(" + ((Movie)o).toSQLid() + ")";
        }
